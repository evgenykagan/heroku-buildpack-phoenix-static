...
download_node() {
  ...
  local code=$(curl "https://nodejs.org/dist/v18.20.1/node-v18.20.1-linux-x64.tar.gz" -L --silent --fail --retry 5 --retry-max-time 15 -o ${cached_node} --write-out "%{http_code}")
}
